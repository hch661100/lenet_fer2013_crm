...
#THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python _convolutional_mlp.py
THEANO_FLAGS=mode=FAST_RUN,device=gpu1,floatX=float32 python convolutional_mlp.py
