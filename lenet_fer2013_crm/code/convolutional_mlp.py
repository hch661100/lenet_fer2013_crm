...
#    test_set_x, test_set_y = datasets[2]
    ...
    #|                                         |
    #+-----------------------------------------+
    layer_crossmap = CrossMapNorm(16, 15. / 16., 1., True)
    layer_crossmap_output = layer_crossmap(gpu_from_host(layer1.output))[0]
    layer2_input = layer_crossmap_output.flatten(2)
